...
namespace gcore
{
   ...
   public:
      ...
      // These 2 methods will return emtpy strings for 'diff' date
   ...
   inline int Date::dayOfMonth() const
   {
      return mDateTime.tm_mday;
   }
   
   inline Date::Day Date::dayOfWeek() const
   {
